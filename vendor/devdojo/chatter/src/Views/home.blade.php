...
<style>
    ...
    @media only screen and (min-width:320px) and (max-width: 650px) {
        ...
        #mceu_53-inp, #mceu_54, #mceu_55, #mceu_56, #mceu_25, #mceu_26{
            width: 30% !important;
        }
        #mceu_27{
            width: 100% !important;
...
<div id="chatter" class="chatter_home" style="display:block;  background-repeat: repeat;  background-attachment: fixed;  background-size: cover;
	...
	<div class="container chatter_container" style="width: 100% !important;">

	    <div class="row">

	    	<div class="col-md-3 left-column"style="padding-top: 5%" >
	    		<!-- SIDEBAR -->
	    		<div class="chatter_sidebar"  >
					<button class="btn btn-primary" id="new_discussion_btn" style="color: white; !important;"><i class="chatter-new"></i> @lang('chatter::messages.discussion.new')</button>
					<a href="/{{ Config::get('chatter.routes.home') }}" style="color: white; !important;"><i class="chatter-bubble"></i> @lang('chatter::messages.discussion.all')</a>
          {!! $categoriesMenu !!}
				</div>
				<!-- END SIDEBAR -->
	    	</div>
	        <div class="col-md-9 right-column"style="padding-top: 5%;" >
	        	<div class="panel">
		        	<ul class="discussions" style="border-radius: 25px">
		        		@foreach($discussions as $discussion)
				        	<li>
				        		<a class="discussion_list"style="border-radius: 25px" href="/{{ Config::get('chatter.routes.home') }}/{{ Config::get('chatter.routes.discussion') }}/{{ $discussion->category->slug }}/{{ $discussion->slug }}">
	...
	<div id="new_discussion" style="z-index: 0;">
