...
@section('content')
    ...
    <!-- adatok listázása-->
    <div class="panel panel-weather"  id="pecsFahren">
        <div class="location"><b>Pecs</b></div>
        <img class="kezdolapikon" src=" {{$ikonPecs}}">
        <div class="span temp">{{$tempCurrentFahrenheitPecs}}<span class="degree">&deg;F</span></div>
        <div class="span text">{{$descriptionPecs}}</div>
        <div class="row" style="padding-top: 30px">
            <div class="col" id="kezdolapleiras1">
                Napkelte: <br> <b>{{$sunrisePecs}}</b> <br><br>
                Napnyugta: <br> <b>{{$sunsetPecs}}</b> <br><br>
            ...
            <div class="col" id="kezdolapleiras2" >
                <i>   Felhőzet:  <br> <b> {{$cloudCoverPecs}} % </b> <br><br>
                    Légnyomás: <br>  <b>{{$pressurePecs}} hPa </b><br><br>
                    Páratartalom: <br> <b> {{$humidityPecs}} % </b><br><br>
                </i>
            </div>
            <div class="col" id="kezdolapleiras3" >
                <i>
                    Hőérzet: <br> <b> {{$tempFahrenheitFeelslikePecs}} &deg;F </b> <br><br>
                    Szélsebesség: <br>   <b> {{$windSpeedPecs}} km/h </b> <br><br>
                    Szélirány: <br> <img class="kezdolapszelirany" src="{{$windDegPecs}}">
                </i>
            </div>
        </div>
    </div>
    <!-- adatok listázása-->
    <div class="panel panel-weather"  id="pecsCelsius">
        <div class="location"><b>Pecs</b></div>
        <img class="kezdolapikon" src=" {{$ikonPecs}}">
        <div class="span temp">{{$tempPecs}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$descriptionPecs}}</div>
        <div class="row" style="padding-top: 30px">
            <div class="col" id="kezdolapleiras1">
                Napkelte: <br> <b>{{$sunrisePecs}}</b> <br><br>
            ...
            <div class="col" id="kezdolapleiras3" >
                <i>
                    Hőérzet: <br> <b> {{$tempFeelslikePecs}} &deg;C </b> <br><br>
                    Szélsebesség: <br>   <b> {{$windSpeedPecs}} km/h </b> <br><br>
                    Szélirány: <br> <img class="kezdolapszelirany" src="{{$windDegPecs}}">
                </i>
            </div>
    ...
    <div  class="panel panel-weather" id="pecs3days">
        <div class="location"><b>Pecs</b></div>
        <img class="kezdolapikon" src=" {{$ikonPecs}}">
        <div class="span temp">{{$tempPecs}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$descriptionPecs}}</div>
    ...
    <div class="panel panel-weather" id="pecs5days">
        <div class="location"><b>Pecs</b></div>
        <img class="kezdolapikon" src=" {{$ikonPecs}}">
        <div class="span temp">{{$tempPecs}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$descriptionPecs}}</div>
    ...
    <script>
        ...
        {
            if(document.getElementById('pecsCelsius').style.display == 'block'){
                document.getElementById('pecsFahren').style.display = 'none';
                document.getElementById('pecs3days').style.display = 'none';
                document.getElementById('pecs5days').style.display = 'none';

            }
            else
                document.getElementById('pecsCelsius').style.display = 'block';
            document.getElementById('pecsFahren').style.display = 'none';
            document.getElementById('pecs3days').style.display = 'none';
            document.getElementById('pecs5days').style.display = 'none';
        });
        ...
        {
            if(document.getElementById('pecsFahren').style.display == 'block'){
                document.getElementById('pecsCelsius').style.display = 'none';
                document.getElementById('pecs3days').style.display = 'none';
                document.getElementById('pecs5days').style.display = 'none';
            }

            else
                document.getElementById('pecsFahren').style.display = 'block';
            document.getElementById('pecsCelsius').style.display = 'none';
            document.getElementById('pecs3days').style.display = 'none';
            document.getElementById('pecs5days').style.display = 'none';
        ...
        {
            if(document.getElementById('pecs3days').style.display == 'block'){
                document.getElementById('pecsCelsius').style.display = 'none';
                document.getElementById('pecsFahren').style.display = 'none';
                document.getElementById('pecs5days').style.display = 'none';
            }
                ...
                document.getElementById('pecs3days').style.display = 'block';
            document.getElementById('pecsCelsius').style.display = 'none';
            document.getElementById('pecsFahren').style.display = 'none';
            document.getElementById('pecs5days').style.display = 'none';
        ...
        {
            if(document.getElementById('pecs5days').style.display == 'block'){
                document.getElementById('pecsCelsius').style.display = 'none';
                document.getElementById('pecsFahren').style.display = 'none';
                document.getElementById('pecs3days').style.display = 'none';
            }
                ...
                document.getElementById('pecs5days').style.display = 'block';
            document.getElementById('pecsCelsius').style.display = 'none';
            document.getElementById('pecsFahren').style.display = 'none';
            document.getElementById('pecs3days').style.display = 'none';
