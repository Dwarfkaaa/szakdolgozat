...
@section('content')
    ...
    <!-- adatok listázása-->
    <div class="panel panel-weather"  id="budapestFahren">
        <div class="location"><b>Budapest</b></div>
        <img class="kezdolapikon" src=" {{$ikonBud}}">
        <div class="span temp">{{$tempCurrentFahrenheitBud}}<span class="degree">&deg;F</span></div>
        <div class="span text">{{$descriptionBud}}</div>
        <div class="row" style="padding-top: 30px">
            <div class="col" id="kezdolapleiras1">
                Napkelte: <br> <b>{{$sunriseBud}}</b> <br><br>
                Napnyugta: <br> <b>{{$sunsetBud}}</b> <br><br>
            ...
            <div class="col" id="kezdolapleiras2" >
                <i>   Felhőzet:  <br> <b> {{$cloudCoverBud}} % </b> <br><br>
                    Légnyomás: <br>  <b>{{$pressureBud}} hPa </b><br><br>
                    Páratartalom: <br> <b> {{$humidityBud}} % </b><br><br>
                </i>
            </div>
            <div class="col" id="kezdolapleiras3" >
                <i>
                    Hőérzet: <br> <b> {{$tempFahrenheitFeelslikeBud}} &deg;F </b> <br><br>
                    Szélsebesség: <br>   <b> {{$windSpeedBud}} km/h </b> <br><br>
                    Szélirány: <br> <img class="kezdolapszelirany" src="{{$windDegBud}}">
                </i>
            </div>
        </div>
    </div>
    <!-- adatok listázása-->
    <div class="panel panel-weather"  id="budapestCelsius">
        <div class="location"><b>Budapest</b></div>
        <img class="kezdolapikon" src=" {{$ikonBud}}">
        <div class="span temp">{{$tempBud}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$descriptionBud}}</div>
        <div class="row" style="padding-top: 30px">
            <div class="col" id="kezdolapleiras1">
                Napkelte: <br> <b>{{$sunriseBud}}</b> <br><br>
            ...
            <div class="col" id="kezdolapleiras3" >
                <i>
                    Hőérzet: <br> <b> {{$tempFeelslikeBud}} &deg;C </b> <br><br>
                    Szélsebesség: <br>   <b> {{$windSpeedBud}} km/h </b> <br><br>
                    Szélirány: <br> <img class="kezdolapszelirany" src="{{$windDegBud}}">
                </i>
            </div>
    ...
    <div  class="panel panel-weather" id="budapest3days">
        <div class="location"><b>Budapest</b></div>
        <img class="kezdolapikon" src=" {{$ikonBud}}">
        <div class="span temp">{{$tempBud}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$descriptionBud}}</div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () =>{
                Highcharts.chart('hom',{
                    ...
                    series:[
                        {
                            name: 'Maximum hőmérséklet - 3 óránkénti előrejelzés',
    ...
    <div class="panel panel-weather" id="budapest5days">
        <div class="location"><b>Budapest</b></div>
        <img class="kezdolapikon" src=" {{$ikonBud}}">
        <div class="span temp">{{$tempBud}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$descriptionBud}}</div>
    ...
    <script>
        ...
        $('#budapest3days').hide();
        $('#budapest5days').hide();
        $('#budapestCelsius').show();
        document.getElementById("gomb1").addEventListener("click", function()
        {
            if(document.getElementById('budapestCelsius').style.display == 'block'){
                document.getElementById('budapestFahren').style.display = 'none';
                document.getElementById('budapest3days').style.display = 'none';
                document.getElementById('budapest5days').style.display = 'none';

            }
            else
                document.getElementById('budapestCelsius').style.display = 'block';
            document.getElementById('budapestFahren').style.display = 'none';
            document.getElementById('budapest3days').style.display = 'none';
            document.getElementById('budapest5days').style.display = 'none';
        });
        ...
        {
            if(document.getElementById('budapestFahren').style.display == 'block'){
                document.getElementById('budapestCelsius').style.display = 'none';
                document.getElementById('budapest3days').style.display = 'none';
                document.getElementById('budapest5days').style.display = 'none';
            }

            else
                document.getElementById('budapestFahren').style.display = 'block';
            document.getElementById('budapestCelsius').style.display = 'none';
            document.getElementById('budapest3days').style.display = 'none';
            document.getElementById('budapest5days').style.display = 'none';
        ...
        {
            if(document.getElementById('budapest3days').style.display == 'block'){
                document.getElementById('budapestCelsius').style.display = 'none';
                document.getElementById('budapestFahren').style.display = 'none';
                document.getElementById('budapest5days').style.display = 'none';
            }
                ...
                document.getElementById('budapest3days').style.display = 'block';
            document.getElementById('budapestCelsius').style.display = 'none';
            document.getElementById('budapestFahren').style.display = 'none';
            document.getElementById('budapest5days').style.display = 'none';
        ...
        {
            if(document.getElementById('budapest5days').style.display == 'block'){
                document.getElementById('budapestCelsius').style.display = 'none';
                document.getElementById('budapestFahren').style.display = 'none';
                document.getElementById('budapest3days').style.display = 'none';
            }
                ...
                document.getElementById('budapest5days').style.display = 'block';
            document.getElementById('budapestCelsius').style.display = 'none';
            document.getElementById('budapestFahren').style.display = 'none';
            document.getElementById('budapest3days').style.display = 'none';
