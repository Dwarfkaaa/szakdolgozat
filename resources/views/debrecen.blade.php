...
@section('content')
    ...
    <!-- adatok listázása-->
    <div class="panel panel-weather"  id="debrecenFahren">
        <div class="location"><b>Debrecen</b></div>
        <img class="kezdolapikon" src=" {{$ikonDeb}}">
        <div class="span temp">{{$tempCurrentFahrenheitDeb}}<span class="degree">&deg;F</span></div>
        <div class="span text">{{$descriptionDeb}}</div>
        <div class="row" style="padding-top: 30px">
            <div class="col" id="kezdolapleiras1">
                Napkelte: <br> <b>{{$sunriseDeb}}</b> <br><br>
                Napnyugta: <br> <b>{{$sunsetDeb}}</b> <br><br>
            ...
            <div class="col" id="kezdolapleiras2" >
                <i>   Felhőzet:  <br> <b> {{$cloudCoverDeb}} % </b> <br><br>
                    Légnyomás: <br>  <b>{{$pressureDeb}} hPa </b><br><br>
                    Páratartalom: <br> <b> {{$humidityDeb}} % </b><br><br>
                </i>
            </div>
            <div class="col" id="kezdolapleiras3" >
                <i>
                    Hőérzet: <br> <b> {{$tempFahrenheitFeelslikeDeb}} &deg;F </b> <br><br>
                    Szélsebesség: <br>   <b> {{$windSpeedDeb}} km/h </b> <br><br>
                    Szélirány: <br> <img class="kezdolapszelirany" src="{{$windDegDeb}}">
                </i>
            </div>
        </div>
    </div>
    <!-- adatok listázása-->
    <div class="panel panel-weather"  id="debrecenCelsius">
        <div class="location"><b>Debrecen</b></div>
        <img class="kezdolapikon" src=" {{$ikonDeb}}">
        <div class="span temp">{{$tempDeb}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$descriptionDeb}}</div>
        <div class="row" style="padding-top: 30px">
            <div class="col" id="kezdolapleiras1">
                Napkelte: <br> <b>{{$sunriseDeb}}</b> <br><br>
            ...
            <div class="col" id="kezdolapleiras3" >
                <i>
                    Hőérzet: <br> <b> {{$tempFeelslikeDeb}} &deg;C </b> <br><br>
                    Szélsebesség: <br>   <b> {{$windSpeedDeb}} km/h </b> <br><br>
                    Szélirány: <br> <img class="kezdolapszelirany" src="{{$windDegDeb}}">
                </i>
            </div>
    ...
    <div  class="panel panel-weather" id="debrecen3days">
        <div class="location"><b>Debrecen</b></div>
        <img class="kezdolapikon" src=" {{$ikonDeb}}">
        <div class="span temp">{{$tempDeb}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$descriptionDeb}}</div>
    ...
    <div class="panel panel-weather" id="debrecen5days">
        <div class="location"><b>Debrecen</b></div>
        <img class="kezdolapikon" src=" {{$ikonDeb}}">
        <div class="span temp">{{$tempDeb}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$descriptionDeb}}</div>
    ...
    <script>
        ...
        $('#debrecen3days').hide();
        $('#debrecen5days').hide();
        $('#debrecenCelsius').show();
        document.getElementById("gomb1").addEventListener("click", function()
        {
            if(document.getElementById('debrecenCelsius').style.display == 'block'){
                document.getElementById('debrecenFahren').style.display = 'none';
                document.getElementById('debrecen3days').style.display = 'none';
                document.getElementById('debrecen5days').style.display = 'none';

            }
            else
                document.getElementById('debrecenCelsius').style.display = 'block';
            document.getElementById('debrecenFahren').style.display = 'none';
            document.getElementById('debrecen3days').style.display = 'none';
            document.getElementById('debrecen5days').style.display = 'none';
        });
        ...
        {
            if(document.getElementById('debrecenFahren').style.display == 'block'){
                document.getElementById('debrecenCelsius').style.display = 'none';
                document.getElementById('debrecen3days').style.display = 'none';
                document.getElementById('debrecen5days').style.display = 'none';
            }

            else
                document.getElementById('debrecenFahren').style.display = 'block';
            document.getElementById('debrecenCelsius').style.display = 'none';
            document.getElementById('debrecen3days').style.display = 'none';
            document.getElementById('debrecen5days').style.display = 'none';
        ...
        {
            if(document.getElementById('debrecen3days').style.display == 'block'){
                document.getElementById('debrecenCelsius').style.display = 'none';
                document.getElementById('debrecenFahren').style.display = 'none';
                document.getElementById('debrecen5days').style.display = 'none';
            }
                ...
                document.getElementById('debrecen3days').style.display = 'block';
            document.getElementById('debrecenCelsius').style.display = 'none';
            document.getElementById('debrecenFahren').style.display = 'none';
            document.getElementById('debrecen5days').style.display = 'none';
        ...
        {
            if(document.getElementById('debrecen5days').style.display == 'block'){
                document.getElementById('debrecenCelsius').style.display = 'none';
                document.getElementById('debrecenFahren').style.display = 'none';
                document.getElementById('debrecen3days').style.display = 'none';
            }
                ...
                document.getElementById('debrecen5days').style.display = 'block';
            document.getElementById('debrecenCelsius').style.display = 'none';
            document.getElementById('debrecenFahren').style.display = 'none';
            document.getElementById('debrecen3days').style.display = 'none';
