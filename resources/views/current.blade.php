...
@section('content')
    ...
    <div class="panel panel-weather"  id="currentFahren">
    ...
    <div class="panel panel-weather"  id="currentCelsius">
        <div class="location"><b>{{$name}}</b></div>
        <img class="kezdolapikon" src=" {{$ikon}}">
    ...
    <div  class="panel panel-weather" id="current3days">
        <div class="location"><b>{{$name}}</b></div>
        <img class="kezdolapikon" src=" {{$ikon}}">
        <div class="span temp">{{$temp}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$description}}</div>
    ...
    <div class="panel panel-weather" id="current5days">
        <div class="location"><b>{{$name}}</b></div>
        <img class="kezdolapikon" src=" {{$ikon}}">
        <div class="span temp">{{$temp}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$description}}</div>
    ...
    <script>
        ...
        {
            if(document.getElementById('currentCelsius').style.display == 'block'){
                document.getElementById('currentFahren').style.display = 'none';
                document.getElementById('current3days').style.display = 'none';
                document.getElementById('current5days').style.display = 'none';

            }
            else
                document.getElementById('currentCelsius').style.display = 'block';
            document.getElementById('currentFahren').style.display = 'none';
            document.getElementById('current3days').style.display = 'none';
            document.getElementById('current5days').style.display = 'none';
        });
        ...
        {
            if(document.getElementById('currentFahren').style.display == 'block'){
                document.getElementById('currentCelsius').style.display = 'none';
                document.getElementById('current3days').style.display = 'none';
                document.getElementById('current5days').style.display = 'none';
            }

            else
                document.getElementById('currentFahren').style.display = 'block';
            document.getElementById('currentCelsius').style.display = 'none';
            document.getElementById('current3days').style.display = 'none';
            document.getElementById('current5days').style.display = 'none';
        ...
        {
            if(document.getElementById('current3days').style.display == 'block'){
                document.getElementById('currentCelsius').style.display = 'none';
                document.getElementById('currentFahren').style.display = 'none';
                document.getElementById('current5days').style.display = 'none';
            }
                ...
                document.getElementById('current3days').style.display = 'block';
            document.getElementById('currentCelsius').style.display = 'none';
            document.getElementById('currentFahren').style.display = 'none';
            document.getElementById('current5days').style.display = 'none';
        ...
        {
            if(document.getElementById('current5days').style.display == 'block'){
                document.getElementById('currentCelsius').style.display = 'none';
                document.getElementById('currentFahren').style.display = 'none';
                document.getElementById('current3days').style.display = 'none';
            }
                ...
                document.getElementById('current5days').style.display = 'block';
            document.getElementById('currentCelsius').style.display = 'none';
            document.getElementById('currentFahren').style.display = 'none';
            document.getElementById('current3days').style.display = 'none';
