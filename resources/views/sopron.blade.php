...
@section('content')
    ...
    <!-- adatok listázása-->
    <div class="panel panel-weather"  id="sopronFahren">
        <div class="location"><b>Sopron</b></div>
        <img class="kezdolapikon" src=" {{$ikonSopron}}">
        <div class="span temp">{{$tempCurrentFahrenheitSopron}}<span class="degree">&deg;F</span></div>
        <div class="span text">{{$descriptionSopron}}</div>
        <div class="row" style="padding-top: 30px">
            <div class="col" id="kezdolapleiras1">
                Napkelte: <br> <b>{{$sunriseSopron}}</b> <br><br>
                Napnyugta: <br> <b>{{$sunsetSopron}}</b> <br><br>
            ...
            <div class="col" id="kezdolapleiras2" >
                <i>   Felhőzet:  <br> <b> {{$cloudCoverSopron}} % </b> <br><br>
                    Légnyomás: <br>  <b>{{$pressureSopron}} hPa </b><br><br>
                    Páratartalom: <br> <b> {{$humiditySopron}} % </b><br><br>
                </i>
            </div>
            <div class="col" id="kezdolapleiras3" >
                <i>
                    Hőérzet: <br> <b> {{$tempFahrenheitFeelslikeSopron}} &deg;F </b> <br><br>
                    Szélsebesség: <br>   <b> {{$windSpeedSopron}} km/h </b> <br><br>
                    Szélirány: <br> <img class="kezdolapszelirany" src="{{$windDegSopron}}">
                </i>
            </div>
        </div>
    </div>
    <!-- adatok listázása-->
    <div class="panel panel-weather"  id="sopronCelsius">
        <div class="location"><b>Sopron</b></div>
        <img class="kezdolapikon" src=" {{$ikonSopron}}">
        <div class="span temp">{{$tempSopron}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$descriptionSopron}}</div>
        <div class="row" style="padding-top: 30px">
            <div class="col" id="kezdolapleiras1">
                Napkelte: <br> <b>{{$sunriseSopron}}</b> <br><br>
            ...
            <div class="col" id="kezdolapleiras3" >
                <i>
                    Hőérzet: <br> <b> {{$tempFeelslikeSopron}} &deg;C </b> <br><br>
                    Szélsebesség: <br>   <b> {{$windSpeedSopron}} km/h </b> <br><br>
                    Szélirány: <br> <img class="kezdolapszelirany" src="{{$windDegSopron}}">
                </i>
            </div>
    ...
    <div  class="panel panel-weather" id="sopron3days">
        <div class="location"><b>Sopron</b></div>
        <img class="kezdolapikon" src=" {{$ikonSopron}}">
        <div class="span temp">{{$tempSopron}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$descriptionSopron}}</div>
    ...
    <div class="panel panel-weather" id="sopron5days">
        <div class="location"><b>Sopron</b></div>
        <img class="kezdolapikon" src=" {{$ikonSopron}}">
        <div class="span temp">{{$tempSopron}}<span class="degree">&deg;C</span></div>
        <div class="span text">{{$descriptionSopron}}</div>
    ...
    <script>
        ...
        {
            if(document.getElementById('sopronCelsius').style.display == 'block'){
                document.getElementById('sopronFahren').style.display = 'none';
                document.getElementById('sopron3days').style.display = 'none';
                document.getElementById('sopron5days').style.display = 'none';

            }
            else
                document.getElementById('sopronCelsius').style.display = 'block';
            document.getElementById('sopronFahren').style.display = 'none';
            document.getElementById('sopron3days').style.display = 'none';
            document.getElementById('sopron5days').style.display = 'none';
        });
        ...
        {
            if(document.getElementById('sopronFahren').style.display == 'block'){
                document.getElementById('sopronCelsius').style.display = 'none';
                document.getElementById('sopron3days').style.display = 'none';
                document.getElementById('sopron5days').style.display = 'none';
            }

            else
                document.getElementById('sopronFahren').style.display = 'block';
            document.getElementById('sopronCelsius').style.display = 'none';
            document.getElementById('sopron3days').style.display = 'none';
            document.getElementById('sopron5days').style.display = 'none';
        ...
        {
            if(document.getElementById('sopron3days').style.display == 'block'){
                document.getElementById('sopronCelsius').style.display = 'none';
                document.getElementById('sopronFahren').style.display = 'none';
                document.getElementById('sopron5days').style.display = 'none';
            }
                ...
                document.getElementById('sopron3days').style.display = 'block';
            document.getElementById('sopronCelsius').style.display = 'none';
            document.getElementById('sopronFahren').style.display = 'none';
            document.getElementById('sopron5days').style.display = 'none';
        ...
        {
            if(document.getElementById('sopron5days').style.display == 'block'){
                document.getElementById('sopronCelsius').style.display = 'none';
                document.getElementById('sopronFahren').style.display = 'none';
                document.getElementById('sopron3days').style.display = 'none';
            }
                ...
                document.getElementById('sopron5days').style.display = 'block';
            document.getElementById('sopronCelsius').style.display = 'none';
            document.getElementById('sopronFahren').style.display = 'none';
            document.getElementById('sopron3days').style.display = 'none';
