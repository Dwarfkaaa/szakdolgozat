...
L.OWM = L.TileLayer.extend({
	options: {
		appId: '86e5cbb3097836e0f2a884baa56e143a', /* pass your own AppId as parameter when creating the layer. Get your own AppId at https://www.openweathermap.org/appid */
...
L.OWM.Current = L.Layer.extend({
	...
	options: {
		appId: 'f23a8eecdf35264c3edc99cdc4ff715a', // get your free Application ID at www.openweathermap.org
		...
		temperatureDigits: 0,
		speedUnit: 'kmh', // available: 'ms' (m/s), 'kmh' (km/h), 'mph' (mph)
		speedDigits: 0,
	...
	_icondivtext: function(station, imageurl, width, height) {
		var txt = '';
		txt += '<div class="owm-icondiv" style="background-color: white">'
...
L.OWM.Utils = {
	...
	i18n: {
		en: {
			...
			, temp_minmax: 'Hőm. Min/Max'
			, wind: 'Szél'
			, windforce: 'Szél erőssége'
			, direction: 'Irány'
			, rain_1h: 'Eső'
		...
		// weather conditions, see https://openweathermap.org/weather-conditions
			...
			, id800: 'Tiszta idő'
			, id801: 'Néhol felhős'
			, id802: 'Többnyire felhős'
			, id803: 'Borult idő'
			, id804: 'Borult idő'

			, id900: 'Tornado'
			, id901: 'Trópikus zivatar'
			, id902: 'Hurrikán'
			, id903: 'Hideg'
			, id904: 'Forróság'
			, id905: 'Szeles idő'
